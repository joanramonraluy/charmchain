...
export default function CharmSelector({ onSend, onClose }) {
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <button
            onClick={handleSend}
            disabled={!selectedCharm || (!selectedAmount && selectedAmount !== "custom")}
            className={`w-full py-2 rounded-xl text-lg font-medium transition-all ${
              selectedCharm && (selectedAmount || selectedAmount === "custom")
